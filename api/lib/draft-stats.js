...
// Node (Azure Functions) consumes this module too — see api/lib/draft-stats.js.
// The browser keeps using the `draftStats` global; this export is inert there.
if (typeof module !== 'undefined' && module.exports) { module.exports = draftStats; }
